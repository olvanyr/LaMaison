...
if place_meeting(x,y,oTile) instance_destroy();

//collision
right =			place_meeting(x+1,y,oTile);
left =			place_meeting(x-1,y,oTile);
top =			place_meeting(x,y-1,oTile);
bottom =		place_meeting(x,y+1,oTile);

top_left =		position_meeting(bbox_left-1,bbox_top-1,oTile);
bottom_left =	position_meeting(bbox_left-1,bbox_bottom+1,oTile);
top_right =		position_meeting(bbox_right+1,bbox_top-1,oTile);
bottom_right =	position_meeting(bbox_right+1,bbox_bottom+1,oTile);
